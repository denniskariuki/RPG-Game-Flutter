...
final List<Skill> allSkills =[
  ...
  Skill(id:'9', name: 'Infinite Loop', image: 'i_loop.jpg', vocation: Vocation.ninja),
  Skill(id:'10', name: 'Type Cast', image: 't_cast.jpg', vocation: Vocation.ninja),
  Skill(id:'11', name: 'Encapsulate', image: 'encapsulate.jpg', vocation: Vocation.ninja),
  Skill(id:'12', name: 'Copy and Past', image: '', vocation: Vocation.ninja),

  Skill(id:'13', name: 'Gamify', image: 'gamify.jpg', vocation: Vocation.junkie),
  Skill(id:'14', name: 'Heat Map', image: 'h_map.jpg', vocation: Vocation.junkie),
  Skill(id:'15', name: 'Wireframe', image: 'wireframe.jpg', vocation: Vocation.junkie),
  Skill(id:'16', name: 'Dark Pattern', image: 'd_pattern.jpg', vocation: Vocation.junkie),
